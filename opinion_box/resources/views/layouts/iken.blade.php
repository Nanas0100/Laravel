...
<head>
    ...
    <meta property="og:title" content="{{$title->title}} | 意見箱">
    <meta property="og:description" content="{{$title->title}} | 意見箱">
    ...
    <meta property="og:site_name" content="{{$title->title}} | 意見箱">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:image" content="https://ikenbako.sakura.ne.jp/images/{{$title->image}}">
