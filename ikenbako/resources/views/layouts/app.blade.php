...
<head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="description" content="意見箱は、匿名で意見を出来るサービスです。URLをTwitterに投稿して、匿名の意見を集めることができます。" />
    <meta property="og:title" content="意見箱 -登録・ログイン-">
    <meta property="og:description" content="意見箱は、匿名で意見を出来るサービスです。URLをTwitterに投稿して、匿名の意見を集めることができます。">
