...
<head>
    ...
    <meta name="description" content="意見箱の投稿です。{{$title->title}}" />
    <meta property="og:title" content="{{$name->name}}さんの意見箱 | 意見箱">
    <meta property="og:description" content="{{$name->name}}さんの意見箱 | 意見箱">
    <meta name="keywords" content="意見箱,意見,箱,匿名" />
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://localhost:8000">
    <meta property="og:image" content="/images/{{$title->image}}">
    <meta property="og:site_name" content="{{$name->name}}さんの意見箱 | 意見箱">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:image" content="https://localhost:8000/images/{{$title->image}}">
