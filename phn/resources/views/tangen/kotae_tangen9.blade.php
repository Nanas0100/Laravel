...
<br>
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <br><br>
                  @if($m->id==90)
                  <img src="/images/104_24_gozen.png"><br>
                  @elseif($m->id==91)
                  <img src="/images/104_31_gozen.png"><br>
                  @endif
                  <br>
<p>{{$m->mondai}}</p>
<br><br>
...
<br><br>
@endif
<a href="{{route('kako.tangen9',$m->number)}}" class="btn btn-block btn-info" style="background:#00AA00; color:white; border:2px solid #00AA00;">次へ</a>
