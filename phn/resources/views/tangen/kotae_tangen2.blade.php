...
<br>
@if($m->kaisetu==12)
<img src="/images/104_48_gogo.png"><br>
@elseif($m->kaisetu==13)
<img src="/images/104_48_gogo.png"><br>
@endif
<br><br>
...
<br><br>
@endif
<a href="{{route('kako.tangen2',$m->number)}}" class="btn btn-block btn-info" style="background:#00AA00; color:white; border:2px solid #00AA00;">次へ</a>
