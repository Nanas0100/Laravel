...
<br><br>
@if($m->kaisetu==45)
<img src="/images/104_44_gozen.png"><br>
@elseif($m->kaisetu==44)
<img src="/images/11.png"><br>
@elseif($m->kaisetu==54)
<img src="/images/104_45_gozen.png"><br>
@elseif($m->kaisetu==55)
<img src="/images/104_45_gozen.png"><br>
@elseif($m->kaisetu==46)
<img src="/images/104_44_gozen.png"><br>
@elseif($m->kaisetu==41)
<img src="/images/104_26_gogo.png"><br>
@endif
<br><br>
@if($a=='正解')
...
<br><br>
@endif
<a href="{{route('kako.tangen4',$m->number)}}" class="btn btn-block btn-info" style="background:#00AA00; color:white; border:2px solid #00AA00;">次へ</a>
