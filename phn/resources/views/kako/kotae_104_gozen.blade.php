...
<p>{{$kaisetu->kaisetu}}</p><br>

<br><br>
@endif
<a href="{{route('kako.104gozen',$m->number)}}" class="btn btn-block btn-info" style="background:#00AA00; color:white; border:2px solid #00AA00;">次へ</a>
